    ...
    return Container(
        ...
        child: FutureBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<PixelModel> snapshot) {
              if (snapshot.hasData) {
                String dateFormat = DateFormat.yMMMMEEEEd().format(snapshot.data.createdAt).toString();
                return Column(
                    children: [
                      Container(
                      ...
                      AuthorInsights(authorName: snapshot.data.author, likesCount: snapshot.data.likes, commentsCount: snapshot.data.comments.length),
                      Padding(
